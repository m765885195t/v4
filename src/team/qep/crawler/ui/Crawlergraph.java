...
//	      jfreechart = ChartFactory.createLineChart3D("", "", "",getDataSet(), PlotOrientation.VERTICAL, true, true, false);  
...
//		    jfreechart.setBorderVisible(true);// 边框可见  
	        ...
	        categoryplot.setNoDataMessageFont(new Font("sans-serif", 1, 25));//字体的大�?  
	        ...
	        renderer.setBaseShapesVisible(true);   // 数据点可�?  
...
//	         numberaxis.setTickUnit(new NumberTickUnit(1));//指定Y轴数据间�?  
	        ...
	        numberaxis.setUpperMargin(0.1);//设置�?高数据显示与顶端的距�?
	    }  
